...
!function(n) {
    ...
    h.emulateHTTP = !1,
    h.emulateJSON = !1;
    var a, n = h.Events = {}, u = /\s+/, c = function(t, e, i, n, s) {
        var r, o = 0;
    ...
    n.listenTo = function(t, e, i) {
        ...
        var n = t._listenId || (t._listenId = b.uniqueId("l"))
          ...
          , r = a = s[n];
        r || (this._listenId || (this._listenId = b.uniqueId("l")),
    ...
    n.stopListening = function(t, e, i) {
        ...
        return b.isEmpty(n) && (this._listeningTo = void 0),
        this
    }
    ;
    ...
    n.trigger = function(t) {
        ...
        for (var e = Math.max(0, arguments.length - 1), i = Array(e), n = 0; n < e; n++)
            i[n] = arguments[n + 1];
        return c(f, this._events, t, void 0, i),
        this
    }
    ;
    ...
    b.extend(v.prototype, n, {
        ...
        set: function(t, e, i) {
            ...
            var s = i.unset
              ...
              , t = this._changing;
            this._changing = !0,
            t || (this._previousAttributes = b.clone(this.attributes),
            this.changed = {});
            var h, a = this.attributes, u = this.changed, c = this._previousAttributes;
            for (h in n)
                e = n[h],
        ...
        destroy: function(e) {
            ...
            return this.isNew() ? b.defer(e.success) : (B(this, e),
    ...
    b.extend(m.prototype, n, {
        ...
        set: function(t, e) {
            if (null != t) {
                ...
                for (var s = [], r = [], o = [], h = [], a = {}, u = e.add, c = e.merge, l = e.remove, d = !1, f = this.comparator && null == n && !1 !== e.sort, p = b.isString(this.comparator) ? this.comparator : null, g = 0; g < t.length; g++) {
                    ...
                    a[_.cid] || (a[_.cid] = !0,
                    s.push(_)),
                    t[g] = _) : u && (m = t[g] = this._prepareModel(m, e)) && (r.push(m),
        ...
        _prepareModel: function(t, e) {
            ...
            return t.validationError ? (this.trigger("invalid", this, t.validationError, e),
            !1) : t
        },
        ...
        _onModelEvent: function(t, e, i, n) {
            if (e) {
                ...
                "change" !== t || (s = this.modelId(e.previousAttributes())) !== (r = this.modelId(e.attributes)) && (null != s && delete this._byId[s],
    ...
    E.prototype.next = function() {
        if (this._collection) {
            if (this._index < this._collection.length) {
                ...
                return this._index++,
                {
                    value: this._kind === k ? e : (t = this._collection.modelId(e.attributes),
                    this._kind === I ? t : [t, e]),
                    done: !1
                }
            }
    ...
    b.extend(e.prototype, n, {
        ...
        delegateEvents: function(t) {
            ...
            t) {
                var i = t[e];
                (i = !b.isFunction(i) ? this[i] : i) && (e = e.match(T),
    ...
    h.sync = function(t, e, n) {
        ...
        !n.emulateHTTP || "PUT" !== i && "DELETE" !== i && "PATCH" !== i || (r.type = "POST",
        ...
        return e.trigger("request", e, r, n),
        r
    }
    ;
    var C = {
    ...
    b.extend(O.prototype, n, {
        ...
        start: function(t) {
            ...
            (e = (e = document.body).insertBefore(this.iframe, e.firstChild).contentWindow).document.open(),
            e.document.close(),
            ...
            ;
            if (this._usePushState ? e("popstate", this.checkUrl, !1) : this._useHashChange && !this.iframe ? e("hashchange", this.checkUrl, !1) : this._wantsHashChange && (this._checkUrlInterval = setInterval(this.checkUrl, this.interval)),
            !this.options.silent)
                return this.loadUrl()
        },
        stop: function() {
