...
!function(t) {
    ...
    u.ui = u.ui || {},
    u.ui.version = "1.12.1";
    var l, d, a, p, t, h, g, m, s, e, b, o, i, c, f, v, n, r, y, x, C, w = "ui-effects-", k = "ui-effects-style", _ = "ui-effects-animated", S = u;
    function M(t, e, n) {
        var r = m[e.type] || {};
    ...
    function B(r) {
        ...
        o.length ? ("0,0,0,0" === o.join() && l.extend(o, a.transparent),
        i) : a[r]
    }
    function H(t, e, n) {
    ...
    function I(t) {
        var e, n, r = t.ownerDocument.defaultView ? t.ownerDocument.defaultView.getComputedStyle(t, null) : t.currentStyle, i = {};
 ...
 */
    ...
    (h.fn = l.extend(h.prototype, {
        parse: function(i, t, e, n) {
            if (i === d)
                ...
                this;
            (i.jquery || i.nodeType) && (i = l(i).css(t),
            t = d);
            var o = this
              , r = l.type(i)
              , s = this._rgba = [];
            return t !== d && (i = [i, t, e, n],
            r = "array"),
            "string" === r ? this.parse(B(i) || a._default) : "array" === r ? (b(g.rgba.props, function(t, e) {
                s[e.idx] = M(i[e.idx], e)
            }),
            ...
            : function(t, n) {
                ...
                o[r] && l.inArray(null, o[r].slice(0, 3)) < 0 && (o[r][3] = 1,
                n.from && (o._rgba = n.from(o[r])))
            }
            ),
            this) : void 0
        },
        ...
        transition: function(t, s) {
            ...
            return b(n.props, function(t, e) {
                var n = e.idx
                  ...
                  , i = f[n]
                  , o = m[e.type] || {};
                null !== i && (null === r ? c[n] = i : (o.mod && (i - r > o.mod / 2 ? r += o.mod : r - i > o.mod / 2 && (r -= o.mod)),
                c[n] = M((i - r) * s + r, e)))
            }),
            this[e](c)
        },
    ...
    b(g, function(c, t) {
        ...
        h.fn[c] = function(t) {
            ...
            t === d)
                return this[s].slice();
            var e, n = l.type(t), r = "array" === n || "object" === n ? t : arguments, i = this[s].slice();
        ...
        b(o, function(s, a) {
            h.fn[s] || (h.fn[s] = function(t) {
                var e, n = l.type(t), r = "alpha" === s ? this._hsla ? "hsla" : "rgba" : c, i = this[r](), o = i[a.idx];
                return "undefined" === n ? o : ("function" === n && (t = t.call(this, o),
                n = l.type(t)),
                null == t && a.empty ? this : ("string" === n && (e = p.exec(t)) && (t = o + parseFloat(e[2]) * ("+" === e[1] ? 1 : -1)),
                i[a.idx] = t,
                this[r](i)))
            }
            )
    ...
    (h.hook = function(t) {
        ...
        b(t, function(t, o) {
            ...
            l.fx.step[o] = function(t) {
                t.colorInit || (t.start = h(t.elem, o),
                t.end = h(t.end),
                t.colorInit = !0),
        ...
        return this.queue(function() {
            ...
            e = e.map(function() {
                ...
                this.diff = function(t, e) {
                    ...
                    for (n in e)
                        r = e[n],
                        t[n] !== r && (v[n] || !u.fx.step[n] && isNaN(parseFloat(r)) || (i[n] = r));
                    return i
                }(this.start, this.end),
                this
            }),
    ...
    u.fn.extend({
        ...
        removeClass: (i = u.fn.removeClass,
        function(t, e, n, r) {
    ...
    u.expr && u.expr.filters && u.expr.filters.animated && (u.expr.filters.animated = (n = u.expr.filters.animated,
    function(t) {
    ...
    u.fn.extend({
        effect: function() {
            ...
            function f(t) {
                var e = u(this);
                function n() {
                    u.isFunction(s) && s.call(e[0]),
                    u.isFunction(t) && t()
                }
                r.mode = c.shift(),
                !1 === u.uiBackCompat || o ? "none" === r.mode ? (e[a](),
                n()) : i.call(e[0], r, function() {
                    e.removeData(_),
                    u.effects.cleanUp(e),
                    "hide" === r.mode && e.hide(),
                    n()
        ...
        toggle: (r = u.fn.toggle,
        function(t) {
            if (F(t) || "boolean" == typeof t)
